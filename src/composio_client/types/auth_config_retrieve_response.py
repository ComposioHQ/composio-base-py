...
__all__ = ["AuthConfigRetrieveResponse", "ToolAccessConfig", "Toolkit", "ExpectedInputField", "ProxyConfig"]
...
class ExpectedInputField(BaseModel):
    description: str
...
class AuthConfigRetrieveResponse(BaseModel):
    ...
    expected_input_fields: Optional[List[ExpectedInputField]] = None
