...
import regenerate_api_key_org from './org/regenerate-api-key-org';
import retrieve_api_key_org from './org/retrieve-api-key-org';
...
addEndpoint(regenerate_api_key_org);
addEndpoint(retrieve_api_key_org);
