...
import execute_tools_execute from './tools/execute/execute-tools-execute';
import input_tools_execute from './tools/execute/input-tools-execute';
...
addEndpoint(execute_tools_execute);
addEndpoint(input_tools_execute);
