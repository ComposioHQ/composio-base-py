import fs from 'fs';
import type { ResponseLike } from 'composio-sdk/internal/to-file';
import { toFile } from 'composio-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('composio-sdk/core/uploads');
    await expect(
