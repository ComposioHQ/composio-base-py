...
import { APIPromise } from 'composio-sdk/core/api-promise';

import util from 'node:util';
import ComposioSDK from 'composio-sdk';
import { APIUserAbortError } from 'composio-sdk';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['COMPOSIO_SDK_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: ComposioSDK) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['COMPOSIO_SDK_BASE_URL'] = undefined;
    });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['COMPOSIO_SDK_API_KEY'] = 'My API Key';
    const client = new ComposioSDK();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['COMPOSIO_SDK_API_KEY'] = 'another My API Key';
    const client = new ComposioSDK({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
