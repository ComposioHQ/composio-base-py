...
from composio_sdk import ComposioSDK, AsyncComposioSDK, APIResponseValidationError
from composio_sdk._types import Omit
from composio_sdk._utils import maybe_transform
from composio_sdk._models import BaseModel, FinalRequestOptions
from composio_sdk._constants import RAW_RESPONSE_HEADER
from composio_sdk._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from composio_sdk._base_client import (
    DEFAULT_TIMEOUT,
    HTTPX_DEFAULT_TIMEOUT,
    BaseClient,
    make_request_options,
)
from composio_sdk.types.tools.execute_execute_params import ExecuteExecuteParams
...
class TestComposioSDK:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "composio_sdk/_legacy_response.py",
                        "composio_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "composio_sdk/_compat.py",
    ...
    @mock.patch("composio_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(object, maybe_transform({}, ExecuteExecuteParams)),
    ...
    def test_retries_taken(
        ...
        response = client.tools.execute.with_raw_response.execute(action="action")
...
class TestAsyncComposioSDK:
    ...
    async def test_retries_taken(
        ...
        response = await client.tools.execute.with_raw_response.execute(action="action")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.tools.execute.with_raw_response.execute(
            action="action", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from composio_sdk._utils import asyncify
        from composio_sdk._base_client import get_platform
