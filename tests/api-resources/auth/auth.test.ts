...
describe('resource auth', () => {
  ...
  test.skip('login', async () => {
    const responsePromise = client.auth.login('provider_name');
  ...
  test('oneTap: only required params', async () => {
    const responsePromise = client.auth.oneTap('github', { data: { jwt: 'jwt' }, type: 'jwt' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('oneTap: required and optional params', async () => {
    const response = await client.auth.oneTap('github', { data: { jwt: 'jwt' }, type: 'jwt' });
  });

  test('retrieveCallback', async () => {
    const responsePromise = client.auth.retrieveCallback('github');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
