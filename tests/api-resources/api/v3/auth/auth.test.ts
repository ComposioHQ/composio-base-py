...
describe('resource auth', () => {
  ...
  test.skip('login', async () => {
    const responsePromise = client.api.v3.auth.login('provider_name');
  ...
  test.skip('oneTap: only required params', async () => {
    const responsePromise = client.api.v3.auth.oneTap('github', { data: { jwt: 'jwt' }, type: 'jwt' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('oneTap: required and optional params', async () => {
    const response = await client.api.v3.auth.oneTap('github', { data: { jwt: 'jwt' }, type: 'jwt' });
  });

  // skipped: tests are disabled for the time being
  test.skip('retrieveCallback', async () => {
    const responsePromise = client.api.v3.auth.retrieveCallback('github');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveCallback: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.api.v3.auth.retrieveCallback(
        'github',
        {
          authCode: 'authCode',
          code: 'code',
