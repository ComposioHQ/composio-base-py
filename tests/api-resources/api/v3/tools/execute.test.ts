...
describe('resource execute', () => {
  ...
  test.skip('input: only required params', async () => {
    const responsePromise = client.api.v3.tools.execute.input('actionName', { text: 'text' });
  ...
  test.skip('input: required and optional params', async () => {
    const response = await client.api.v3.tools.execute.input('actionName', {
      text: 'text',
  ...
  test.skip('proxy: only required params', async () => {
    const responsePromise = client.api.v3.tools.execute.proxy({ endpoint: 'endpoint', method: 'GET' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('proxy: required and optional params', async () => {
    const response = await client.api.v3.tools.execute.proxy({
      endpoint: 'endpoint',
      method: 'GET',
      body: {},
  ...
  // skipped: tests are disabled for the time being
  test.skip('run', async () => {
    const responsePromise = client.api.v3.tools.execute.run('action');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('run: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.api.v3.tools.execute.run(
        'action',
        {
          allow_tracing: true,
          arguments: { foo: 'bar' },
