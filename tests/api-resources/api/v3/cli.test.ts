...
describe('resource cli', () => {
  ...
  test.skip('createSession', async () => {
    const responsePromise = client.api.v3.cli.createSession();
  ...
  test.skip('linkSession: only required params', async () => {
    const responsePromise = client.api.v3.cli.linkSession({ id: 'id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('linkSession: required and optional params', async () => {
    const response = await client.api.v3.cli.linkSession({ id: 'id' });
  });

  // skipped: tests are disabled for the time being
  test.skip('retrieveSession: only required params', async () => {
    const responsePromise = client.api.v3.cli.retrieveSession({ id: 'id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveSession: required and optional params', async () => {
    const response = await client.api.v3.cli.retrieveSession({ id: 'id' });
  });
});
